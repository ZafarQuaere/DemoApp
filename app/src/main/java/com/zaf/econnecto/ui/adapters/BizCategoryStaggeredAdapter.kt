...
class BizCategoryStaggeredAdapter(private val context: Context, private val mValues: List<UserCategoryData>) : RecyclerView.Adapter<BizCategoryStaggeredAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var amenityData: UserCategoryData = mValues[position]
        holder.textAmenityName.text = amenityData.category_name
    }
