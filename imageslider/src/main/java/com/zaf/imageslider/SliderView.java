...
import com.zaf.imageslider.IndicatorView.PageIndicatorView;
import com.zaf.imageslider.IndicatorView.animation.type.AnimationType;
import com.zaf.imageslider.IndicatorView.animation.type.BaseAnimation;
import com.zaf.imageslider.IndicatorView.animation.type.ColorAnimation;
import com.zaf.imageslider.IndicatorView.draw.controller.DrawController;
import com.zaf.imageslider.IndicatorView.draw.data.Orientation;
import com.zaf.imageslider.IndicatorView.draw.data.RtlMode;
import com.zaf.imageslider.IndicatorView.utils.DensityUtils;
import com.zaf.imageslider.Transformations.AntiClockSpinTransformation;
import com.zaf.imageslider.Transformations.Clock_SpinTransformation;
import com.zaf.imageslider.Transformations.CubeInDepthTransformation;
import com.zaf.imageslider.Transformations.CubeInRotationTransformation;
import com.zaf.imageslider.Transformations.CubeInScalingTransformation;
import com.zaf.imageslider.Transformations.CubeOutDepthTransformation;
import com.zaf.imageslider.Transformations.CubeOutRotationTransformation;
import com.zaf.imageslider.Transformations.CubeOutScalingTransformation;
import com.zaf.imageslider.Transformations.DepthTransformation;
import com.zaf.imageslider.Transformations.FadeTransformation;
import com.zaf.imageslider.Transformations.FanTransformation;
import com.zaf.imageslider.Transformations.FidgetSpinTransformation;
import com.zaf.imageslider.Transformations.GateTransformation;
import com.zaf.imageslider.Transformations.HingeTransformation;
import com.zaf.imageslider.Transformations.HorizontalFlipTransformation;
import com.zaf.imageslider.Transformations.PopTransformation;
import com.zaf.imageslider.Transformations.SimpleTransformation;
import com.zaf.imageslider.Transformations.SpinnerTransformation;
import com.zaf.imageslider.Transformations.TossTransformation;
import com.zaf.imageslider.Transformations.VerticalFlipTransformation;
import com.zaf.imageslider.Transformations.VerticalShutTransformation;
import com.zaf.imageslider.Transformations.ZoomOutTransformation;

import static com.zaf.imageslider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
public class SliderView extends FrameLayout {
    ...
    private void setUpAttributes(Context context, AttributeSet attrs) {
        ...
        int indicatorRadius = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorRadius, DensityUtils.dpToPx(1)); //change the size of indicator
        int indicatorPadding = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorPadding, DensityUtils.dpToPx(2));
        int indicatorMargin = (int) typedArray.getDimension(R.styleable.SliderView_sliderIndicatorMargin, DensityUtils.dpToPx(8));
