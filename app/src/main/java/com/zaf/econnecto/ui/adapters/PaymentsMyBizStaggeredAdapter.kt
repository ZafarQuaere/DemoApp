...
class PaymentsMyBizStaggeredAdapter(private val context: Context, private val mValues: List<PaymentMethodData>) : RecyclerView.Adapter<PaymentsMyBizStaggeredAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var amenityData: PaymentMethodData = mValues[position]
        holder.textAmenityName.text = amenityData.p_method_name
    }
