package com.zaf.econnecto.crop.task;
...
import com.yalantis.ucrop.task.NklCrop;
import com.zaf.econnecto.crop.callback.BitmapCropCallback;
import com.zaf.econnecto.crop.model.CropParameters;
import com.zaf.econnecto.crop.model.ExifInfo;
import com.zaf.econnecto.crop.model.ImageState;
import com.zaf.econnecto.crop.util.FileUtils;
import com.zaf.econnecto.crop.util.ImageHeaderParser;
 ...
 */
public class BitmapCropTask1 extends AsyncTask<Void, Void, Throwable> {
    ...
    private NklCrop mNklCrop = null;

    public BitmapCropTask1(@Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
    ...
    private boolean crop(float resizeScale) throws IOException {
      ...
      if (shouldCrop) {
            boolean cropped = mNklCrop.cropImage(mImageInputPath, mImageOutputPath,
