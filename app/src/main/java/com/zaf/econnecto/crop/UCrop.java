...
public class UCrop {
    ...
    private static final String EXTRA_PREFIX = "com.nikon.snapbridge.cmru";
    ...
    /**
     * Get Intent to start {@link MyBusinessActivity}
     *
     * @return Intent for {@link MyBusinessActivity}
     */
    public Intent getIntent(@NonNull Context context) {
        mCropIntent.setClass(context, MyBusinessActivity.class);
    ...
    public static class Options {
         ...
         */
        public void setAllowedGestures(@MyBusinessActivity.GestureTypes int tabScale,
                                       @MyBusinessActivity.GestureTypes int tabRotate,
                                       @MyBusinessActivity.GestureTypes int tabAspectRatio) {
