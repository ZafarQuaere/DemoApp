...
public class MyBusinessPresenterLatest extends BasePresenter {
    private final AppLoaderFragment loader;
    private Context mContext;
    private IMyBusinessLatest iMyBusiness;
    private MyBusiness bizDetailData;
    private AddDealsBg addDealsBg;

    public MyBusinessPresenterLatest(Context context, IMyBusinessLatest iBizDetail) {
        super(context);
