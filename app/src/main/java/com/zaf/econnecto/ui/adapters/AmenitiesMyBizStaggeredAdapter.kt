...
class AmenitiesMyBizStaggeredAdapter(private val context: Context, private val mValues: List<AmenityData>) : RecyclerView.Adapter<AmenitiesMyBizStaggeredAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var amenityData: AmenityData = mValues[position]
        holder.textAmenityName.text = amenityData.amenity_name
    }
