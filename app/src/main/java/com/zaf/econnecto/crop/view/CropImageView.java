package com.zaf.econnecto.crop.view;
...
import com.zaf.econnecto.crop.callback.CropBoundsChangeListener;
import com.zaf.econnecto.crop.model.CropParameters;
import com.zaf.econnecto.crop.model.ImageState;
import com.zaf.econnecto.crop.task.BitmapCropTask1;
import com.zaf.econnecto.crop.util.CubicEasing;
import com.zaf.econnecto.crop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
     ...
     * Then creates and executes {@link BitmapCropTask1} with proper parameters.
     */
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,
        ...
        new BitmapCropTask1(getViewBitmap(), imageState, cropParameters, cropCallback).execute();
    }
